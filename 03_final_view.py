...
countries = ['USA', 'India', 'Germany', 'Japan', 'France', 'Canada', 'Italy','Turkey','UK','South Africa']  # Country-specific tables to be created
# DAG definition
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='bkt-health-data',  # Replace with your bucket name
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table='ace-ensign-453414-f0.staging_dataset.global_data',
        source_format='CSV',
    ...
    for country in countries:
        ...
        create_view_task = BigQueryInsertJobOperator(
            task_id=f'create_view_{country.lower().replace(" ", "_")}_table',
            configuration={
                "query": {
                    "query": f"""
